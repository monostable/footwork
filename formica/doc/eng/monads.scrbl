...
The possibility to define and use arbitrary monads allows to separate semantics and syntax, according to the well-known Alan Perlis' principle of "a hundred tools for one data structure". 
In Racket there are 28 different @racket[for] iterators and creating an iterator with new semantics requires non-trivial syntax engineering (according to examples in the Racket Reference Guide).
